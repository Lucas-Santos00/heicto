...
export default props => {
    ...
    const closeWindows = _ =>{
        setIsActived(false)
    }

    if(props.sendError == true){
                ...
                <div id={Styles.background}>
                    <div id={Styles.dialogbox}>
                        ...
                        <div id={Styles.textarea} >
                            <h4>Opss...</h4>
                            <p id={Styles.spaceline} >Algo deu errado</p>
                            <p id={Styles.middleText} >Você só pode enviar 50 fotos por vez.</p>
                            <p>Os arquivos devem ser formato .HEIC</p>
                        </div>
    
                        <svg
                            onClick={closeWindows}
                            id={Styles.btnclose} viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
